...
func (password *Password) CheckPassword(input string) (match bool, err error) {
...
func decodeHash(encodedHash *Password) (p *encodingParams, salt, hash []byte, err error) {
	vals := strings.Split(encodedHash.Password, "$")
	if len(vals) != 6 {
